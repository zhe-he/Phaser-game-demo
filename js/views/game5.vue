...
<script type="text/javascript">
    ...
    export default {
        ...
        mounted(){
            this.$nextTick(()=>{
                ...
                game = new Phaser.Game(240, 400, Phaser.CANVAS, 'game5');
    ...
    function Enemy(config) {
        ...
        this.hitEnemy = function(myBullet, enemy) {
            try{config.firesound.play()}catch(e){console.error(e)}
            myBullet.kill();
            enemy.life--;
            if(enemy.life <= 0) {
                try {config.crashsound.play()}catch(e){console.error(e)}
                enemy.kill();
    ...
    States.boot = function() {
        this.preload = function() {
            ...
            game.load.image('loading', './static/game5/preloader.gif');
        }
    ...
    States.preload = function() {
        this.preload = function() {
            ...
            game.load.image('background', './static/game5/bg.jpg');
            game.load.spritesheet('myplane', './static/game5/myplane.png', 40, 40, 4);
            game.load.spritesheet('startbutton', './static/game5/startbutton.png', 100, 40, 2);
            game.load.spritesheet('replaybutton', './static/game5/replaybutton.png', 80, 30, 2);
            game.load.spritesheet('sharebutton', './static/game5/sharebutton.png', 80, 30, 2);
            game.load.image('mybullet', './static/game5/mybullet.png');
            game.load.image('bullet', './static/game5/bullet.png');
            game.load.image('enemy1', './static/game5/enemy1.png');
            game.load.image('enemy2', './static/game5/enemy2.png');
            game.load.image('enemy3', './static/game5/enemy3.png');
            game.load.spritesheet('explode1', './static/game5/explode1.png', 20, 20, 3);
            game.load.spritesheet('explode2', './static/game5/explode2.png', 30, 30, 3);
            game.load.spritesheet('explode3', './static/game5/explode3.png', 50, 50, 3);
            game.load.spritesheet('myexplode', './static/game5/myexplode.png', 40, 40, 3);
            game.load.image('award', './static/game5/award.png');
            game.load.audio('normalback', './static/game5/normalback.mp3');
            game.load.audio('playback', './static/game5/playback.mp3');
            game.load.audio('fashe', './static/game5/fashe.mp3');
            game.load.audio('crash1', './static/game5/crash1.mp3');
            game.load.audio('crash2', './static/game5/crash2.mp3');
            game.load.audio('crash3', './static/game5/crash3.mp3');
            game.load.audio('ao', './static/game5/ao.mp3');
            game.load.audio('pi', './static/game5/pi.mp3');
            game.load.audio('deng', './static/game5/deng.mp3');
        }
        this.create = function() {
    ...
    States.start = function() {
        ...
        this.myFireBullet = function() {
            if(this.myplane.alive && game.time.now > this.bulletTime) {
                try {this.pi.play()}catch(e){console.error(e)}
                var bullet;
        ...
        this.getAward = function(myplane, award) {
            award.kill();
            try {this.deng.play()}catch(e){console.error(e)}
            if(myplane.level < 3) {
                myplane.level++;
            }
        }
        ...
        // 挂了
        this.dead = function() {
            try {this.ao.play()}catch(e){console.error(e)}
